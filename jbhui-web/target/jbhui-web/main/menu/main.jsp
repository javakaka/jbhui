...
$().ready(function() {
	...
	tabPageHeight =$("#tabPagePanel").height();
	tabPageWidth =$("#tabPagePanel").width();
	//alert('tabPageHeight='+tabPageHeight);
});

function getTabPageHeight(){
	return $("#tabPagePanel").height();
}

function getTabPageWidth(){
	return $("#tabPagePanel").width();
}
</script>
</head>
<body>
