...
var tabpanel;
var toolbar;
var pageHeight =window.parent.tabPageHeight;
var pageWidth =window.parent.tabPageWidth;
$(document).ready(function(){
	pageHeight =window.parent.tabPageHeight;
	$("#navTabDiv").css("height",pageHeight);
	...
	maxLength : 20,
  	...
  	$(window).smartresize(function() {
  		pageHeight =window.parent.getTabPageHeight();
  		pageWidth =window.parent.getTabPageWidth(); 
  		document.getElementById("navTabDiv").style.width ="500px";
  		document.getElementById("navTabDiv").height=pageHeight+"px";
  		$("#navTabDiv").css("width",pageWidth+"px");
  		$("#navTabDiv").css("height",pageHeight+"px");
  		//$("#navTabDiv").hide();
  		console.log('navTabDiv -- width'+$("#navTabDiv").width())
  	});
});
