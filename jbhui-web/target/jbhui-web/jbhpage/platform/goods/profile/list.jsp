	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="HOT">热卖</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="TEAM_BUY">团购</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${row.TEAM_BUY == 1}">可团购</c:when>
							<c:when test="${row.TEAM_BUY == 0}">非团购</c:when>
							<c:otherwise>--</c:otherwise>
						</c:choose>
					</td>
					<td>
