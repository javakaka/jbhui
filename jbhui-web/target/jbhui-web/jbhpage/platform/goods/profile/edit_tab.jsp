...
function onPageLoad()
{
	...
	var attr_url ="<%=basePath%>jbhpage/platform/goods/attribute/edit.do?goods_id=";
	if(typeof id == "undefined" || id == "" )
	{
		Tabs.add("base", "基本信息", base_url);
		Tabs.add("detail", "图文信息", detail_url,false);
		Tabs.add("attribute", "商品属性", attr_url,false);
		Tabs.write("编辑商品", idTabFrame, idTab);
	}
	else
	{
		...
		attr_url +=id;
		Tabs.add("base", "基本信息", base_url);
		Tabs.add("detail", "图文信息", detail_url,true);
