...
<c:forEach items="${goods_list }" var ="goods" varStatus="status">
	<div class="product_item">
		<a href="goods-detail.html?id=${goods.ID }">
			<div class="pic_box">
...
<nav></nav>
	<div class="floor bottom-bar-pannel">
	    <div class="floor-container  ">
			...
			<li><span class="bar-img"><a  page_name="index" href="user-profile.do?id=1"><img src="<%=basePath %>res/jbh/resource/user-home-btn.png"></a></span></li>
		</ul>
		</div>
	</div>
	<!-- 
