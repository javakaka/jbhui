...
var delGoodsId="";
// alert
var $page_alert_tip =$("#page_alert_tip");
var $page_alert_titleclose =$("#page_alert_titleclose");
var $page_alert_cancel =$("#page_alert_cancel");
var $page_alert_close =$("#page_alert_close");

// select all
var $all_check =$(".all_check .check_box");
//¥ 9.9
...
function initPageFuns(){
	$page_alert_titleclose.click(function(){
		$page_alert_tip.css("display","none");
	});
	$page_alert_cancel.click(function(){
		$page_alert_tip.css("display","none");
	});
	$page_alert_close.click(function(){
		if(delGoodsId == "" )
		{
			return;
		}
		var goodsDiv =$("#cart_item_"+delGoodsId);
		goodsDiv.remove();
		$page_alert_tip.css("display","none");
		delGoodsId ="";
		// delete goods from cookie
	...
	$all_check.click(function(){
		...
		{
			$(".product_list .product_list_wrap input[type='checkbox']").prop("checked",true);
		}
		// set cancel
		else{
			$(".product_list .product_list_wrap input[type='checkbox']").removeAttr("checked");
		}
		calGoodsMoneyAndNum();
	});
