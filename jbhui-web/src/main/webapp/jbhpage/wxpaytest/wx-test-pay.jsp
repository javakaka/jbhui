...
<html>
 <head>
  ...
  <link rel="Stylesheet" href="<%=basePath%>jbhpage/wxpaytest/res/css/main.css" />
 </head>
 <body >
  <div id="main" class="wrapper white">
  	<input type="hidden" name="pay_type_value" id="pay_type_value" value="" />
  	<div class="guarentee-summary">
  		测试订单，需支付<span class="red">¥</span> <span class="red">0.01</span>元。
  	</div>
  ...
  <script type="text/javascript" src="<%=basePath%>jbhpage/wxpaytest/res/js/pay-order.js"></script>
 </body>
<script>
