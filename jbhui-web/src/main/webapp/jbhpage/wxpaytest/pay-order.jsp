 ...
 <body >
  <div id="main" class="wrapper white">
  	...
  	<div class="guarentee-summary">
  		您已成功拍下 <span class="red">${goods_row.GOODS_NAME}</span> ，扣除保证金<span class="red">¥</span> <span class="red">${guarentee_row.AUCTION_MONEY}</span>元，您仍需支付<span class="red">¥</span> <span class="red">${NEED_PAY_MONEY}</span>元。
  	</div>
  ...
  <script type="text/javascript" src="<%=basePath%>common/js/pay-order.js"></script>
 </body>
<script>
  ...
  document.querySelector('#payBtn').onclick = function () {
	 wx.chooseWXPay({
 	      ...
 	      success: function (res) {
 	          ...
 	          showMsg('支付成功')
 	          $("#payBtn").hide();
 	         var url =SITE_PATH+"/paimaipage/site/index-goods-detail.do";
 	    	 url +="?id="+goods_id;
