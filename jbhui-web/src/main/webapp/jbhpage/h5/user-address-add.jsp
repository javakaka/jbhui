...
<li>
<input type="text" name="addressDetail" id="addressDetail" value="" placeholder="详细地址" maxlength="100">
</li>
<li>
...
<li><input type="button" class="save" onclick="saveaddress()" value="保存" id="submitAddress"></li>
</ul>
</div>
<nav></nav>
