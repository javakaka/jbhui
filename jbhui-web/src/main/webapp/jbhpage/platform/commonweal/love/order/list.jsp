				...
				<tr>
					...
					<td>
						<c:choose>
							...
							<c:when test="${row.PAY_STATE == 2}">支付完成</c:when>
							<c:otherwise>--</c:otherwise>
						</c:choose>
					</td>
					<td>
						<c:choose>
							<c:when test="${row.PAY_TYPE == 1}">支付宝支付</c:when>
							<c:when test="${row.PAY_TYPE == 2}">银联支付</c:when>
							<c:when test="${row.PAY_TYPE == 3}">微信支付</c:when>
							<c:otherwise>--</c:otherwise>
						</c:choose>
					</td>
					<td>
