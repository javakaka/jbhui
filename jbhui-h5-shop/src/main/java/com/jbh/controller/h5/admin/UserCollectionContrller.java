...
@RequestMapping("/jbhpage/platform/member/collection")
public class UserCollectionContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/member/collection/list";
	}
	
	@RequestMapping(value = "/add")
	public String add(ModelMap model) {
		return "/jbhpage/platform/member/collection/add";
	}
	...
	public String edit(Long id, ModelMap model) throws Exception {
		...
		return "/jbhpage/platform/member/collection/edit";
	}
