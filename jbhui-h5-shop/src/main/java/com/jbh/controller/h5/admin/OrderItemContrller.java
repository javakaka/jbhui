...
@Controller("hslgPlatformOrderItemController")
@RequestMapping("/jbhpage/platform/order/item")
public class OrderItemContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		orderItemService.getRow().put("pageable", pageable);
		Page page = orderItemService.queryPage();
		model.addAttribute("page", page);
		orderItemService.getRow().clear();
		return "/jbhpage/platform/order/item/list";
	}
	
	@RequestMapping(value = "/list-by-order-id")
	public @ResponseBody ResponseVO list(String order_id) {
		ResponseVO ovo =new ResponseVO();
		DataSet list = orderItemService.queryItemsByOrderId(order_id);
		ovo.put("items", list);
		return ovo;
	}
	...
	public String edit(String id, ModelMap model) throws Exception {
		...
		return "/jbhpage/platform/order/edit";
	}
