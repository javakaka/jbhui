...
import com.jbh.service.AdService;

@Controller("hslgPlatformAdController")
@RequestMapping("/jbhpage/platform/ad/profile")
public class AdContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/ad/profile/list";
	}
	...
	public String add(ModelMap model) {
		return "/jbhpage/platform/ad/profile/add";
	}	
	...
	public String edit(String id, ModelMap model) {
		...
		return "/jbhpage/platform/ad/profile/edit";
	}
