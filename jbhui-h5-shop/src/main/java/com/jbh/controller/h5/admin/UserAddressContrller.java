...
@RequestMapping("/jbhpage/platform/member/address")
public class UserAddressContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/member/address/list";
	}
	...
	public String selectUserList(String id,Pageable pageable, ModelMap model) {
		...
		userService.getRow().clear();
		return "/jbhpage/platform/member/address/SelectUser";
	}

	@RequestMapping(value = "/add")
	public String add(ModelMap model) {
		return "/jbhpage/platform/member/address/add";
	}
	...
	public String edit(Long id, ModelMap model) throws Exception {
		...
		return "/jbhpage/platform/member/address/edit";
	}
