...
@RequestMapping("/jbhpage/platform/member/profile")
public class UserContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/member/profile/list";
	}
	...
	public String queryLatestUserList(Pageable pageable, ModelMap model) {
		...
		userService.getRow().clear();
		return "/jbhpage/platform/webpart/LatestUserList";
	}
	...
	public String selectUserList(String id,Pageable pageable, ModelMap model) {
		...
		userService.getRow().clear();
		return "/jbhpage/platform/member/profile/SelectUser";
	}

	@RequestMapping(value = "/add")
	public String add(ModelMap model) {
		return "/jbhpage/platform/member/profile/add";
	}
	...
	public String edit(Long id, ModelMap model) throws Exception {
		...
		return "/jbhpage/platform/member/profile/edit";
	}
