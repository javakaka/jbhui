...
@RequestMapping("/jbhpage/platform/mailbox/sysinfo")
public class MailboxSysInfoContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/mailbox/sysinfo/list";
	}
	
	
	@RequestMapping(value = "/add")
	public String add(ModelMap model) {
		return "/jbhpage/platform/mailbox/sysinfo/add";
	}	
	...
	public String edit(String id, ModelMap model) {
		...
		return "/jbhpage/platform/mailbox/sysinfo/edit";
	}
