...
import com.jbh.service.MailboxSysBroadcastService;

@Controller("hslgPlatformMailboxSysBroadcastController")
@RequestMapping("/jbhpage/platform/mailbox/sysbroadcast")
public class MailboxSysBroadcastContrller  extends BaseController{
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		return "/jbhpage/platform/mailbox/sysbroadcast/list";
	}
	
	
	@RequestMapping(value = "/add")
	public String add(ModelMap model) {
		return "/jbhpage/platform/mailbox/sysbroadcast/add";
	}	
	...
	public String edit(String id, ModelMap model) {
		...
		return "/jbhpage/platform/mailbox/sysbroadcast/edit";
	}
