...
public class UserCollectionService extends JdbcService{
	 ...
	 * @return
	 */
	public int getUserCollectionNum(String user_id)
	{
		int num =0;
		String sql ="  select count(*) from hslg_user_collection_goods where user_id='"+user_id+"' ";
	 ...
	 * @return
	 */
	public int getGoodsTotalCollectionNum(String goodsId)
	{
		int num =0;
		String sql ="  select count(*) from hslg_user_collection_goods where goods_id='"+goodsId+"' ";
		num =Integer.parseInt(queryField(sql));
		return num;
	}
	 ...
	 * @return
	 */
	public int getGoodsTotalCollectionNumByUserId(String userId)
	{
		int num =0;
		String sql ="  select count(*) from hslg_user_collection_goods where user_id='"+userId+"' ";
		num =Integer.parseInt(queryField(sql));
		return num;
	}
