...
public class CommonwealArchiveRecordService extends JdbcService{
	...
	public Page queryPage() {
		...
		String sql ="select * from ( select a.*,b.username,b.telephone from hslg_commonweal_archives_donation_item a ,hslg_users b where a.user_id=b.id) as tab "
		+" where 1=1 ";
		String restrictions = addRestrictions(pageable);
		String orders = addOrders(pageable);
		sql += restrictions;
		sql += orders;
		String countSql ="select count(*) from ( select a.*,b.username,b.telephone from hslg_commonweal_archives_donation_item a ,hslg_users b where a.user_id=b.id) as tab "
		+" where 1=1 ";
