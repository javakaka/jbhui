...
public class GoodsTypeService extends JdbcService{
	...
	public DataSet list()
	{
		...
		String sSql ="select * from hslg_goods_type a where state='1' "
				+" order by a.seq ";
	...
	public String getSelectedId(DataSet ds)
	{
		String id="";
		if (ds == null) {
			return id;
		...
		for (int i = 0; i < ds.size(); i++) {
			...
			String upId =row.getString("UP_ID","");
			if (upId.equals( "-1" )) {
				id = row.getString("ID","");
				break;
			}
